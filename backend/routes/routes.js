import {addData,deleteData,getData,updateData,login,getUser,getReservacionUser,getReservacionAdmin} from "../controller/controller.js"
...
router.get('/admin',getReservacionAdmin);
